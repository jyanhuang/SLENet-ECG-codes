...
import resnet1d_wang as rd_wang
...
class MyNet(nn.Module):
    ...
    def __init__(self, in_channels = 12, num_classes = 6, encoder_fea_dim = 128,
        ...
        super().__init__()
        self.taubu_squeeze_linear = nn.Linear(300, encoder_fea_dim)
...
if __name__ == '__main__':
    ...
    inputs1_scale1 = torch.randn(128, 12, 1, 180)
    inputs1_scale2 = torch.randn(128, 12, 1, 90)
    inputs1_scale3 = torch.randn(128, 12, 1, 45)
    inputs2 = torch.randn(128, 300)
    #info = torch.randn(16, 2)
    SE_ECGNet = MyNet()
    ...
    # with torch.no_grad():
    #     flops, params = profile(SE_ECGNet, inputs=(inputs1_scale1, inputs1_scale2, inputs1_scale3, inputs2))
